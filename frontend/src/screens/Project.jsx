        ...
        receiveMessage('project-message', data => {
            ...
            if (data.sender._id == 'ai') {
                try {
                    ...
                    if (message.fileTree) {
                        const aiFileTree = {};
                        for (const key in message.fileTree) {
                            aiFileTree[key] = { ...message.fileTree[key], generatedByAi: true };
                        }
                    ...
                    console.error('Received message:', data.message);
                }
            } else {
                ...
                <div className="conversation-area pt-14 pb-10 flex-grow flex flex-col h-full relative">
                    ...
                    <div className="inputField w-full flex absolute bottom-0">
                        <input
                            ...
                            type="text"
                            placeholder="Enter message or Write '@ai' to use ai"
                        />
                        ...
                        {Object.keys(fileTree).map((file) => (
                            <div key={file} className="flex items-center justify-between">
                                <button
                                    ...
                                    className="tree-element cursor-pointer p-2 px-4 flex items-center gap-2 bg-slate-300"
                                >
                                    <p className="font-semibold text-lg">{file}</p>
                                </button>
                                {fileTree[file]?.generatedByAi && (
                                    <button
